...
class R2SWrapper_UserUser():
    ...
    def fit(self, users, n):
        ...
        trained_data = self.UserUser.fit(self.ratings)
        self.UserUser = trained_data['self']
        ...
        for u  in users:
            ...
            prediction = self.UserUser.predict_for_user(u,self.ui_coo.col) 
    ...
    def recommend(self, parameters):
        ...
        self.UserUser = UserUser(self.nnbrs)
